...
**Note:** The exact FLAM custom styles must be derived from the example PDF at
`https://github.com/gabriel-card/theo-essays/blob/main/semester-02/hi2-paper-03/hi2_entrega_03.pdf`.
This task provides the structural skeleton; visual style details (fonts, margins,
header/footer) must be filled in after reviewing that document.
...
%
% IMPORTANT: After reviewing the example FLAM PDF, add the institution-specific
% customisations below the "FLAM CUSTOM STYLES" marker.

\NeedsTeXFormat{LaTeX2e}
\ProvidesClass{flam}[2026/03/15 v0.1 FLAM class based on abntex2]

% Pass all options to abntex2 before loading it.
...
% ── FLAM CUSTOM STYLES ────────────────────────────────────────────────────────
% Add institution-specific overrides here (fonts, margins, header/footer, etc.)
% Refer to the example PDF:
%   https://github.com/gabriel-card/theo-essays/blob/main/semester-02/hi2-paper-03/hi2_entrega_03.pdf
% ─────────────────────────────────────────────────────────────────────────────
```
...
git commit -m "feat: flam.cls skeleton (inherits abntex2)"
```
...
% Maps YAML frontmatter to abntex2 macros.
...
\usepackage{longtable}          % Multi-page tables (Pandoc uses these)
...
$if(course)$\tipotrabalho{$course$}$endif$

% ── Document body ─────────────────────────────────────────────────────────────
\begin{document}

\imprimircapa          % Cover page
\imprimirfolhaderosto  % Title page
...
git commit -m "feat: Pandoc LaTeX template with abntex2cite and frontmatter mapping"
```
